...
module.exports = (params,rand,nodemailer) => {
  ...
  let messageBox = "<div style='background-color: #F8F8F8; width: 300px; border: 25px solid #6495ED; padding: 25px; margin: 25px;'>"+
                       "<h1>Hello,</h1><h2>Please click on the link below to verify your email and continue login to Blue Care Services.</h2><br>"+
